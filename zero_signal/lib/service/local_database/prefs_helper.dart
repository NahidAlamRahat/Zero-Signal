...
class PrefsHelper {
  ...
  static Future<void> removeAllPrefData() async {
    ...
    preferences.setString("businessId", "");
    preferences.setString("userId", "");
    preferences.setString("signUpToken", "");
    preferences.setString("myImage", "");
    preferences.setString("myName", "");
    preferences.setString("myEmail", "");
    preferences.setString("myRole", "");
    preferences.setBool("isLogIn", false);
    preferences.setBool("isCreateBusiness", false);
    preferences.setBool("businessLogIn", false);
